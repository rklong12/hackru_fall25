...
def generate_text_and_audio(
    ...
    prompt = (
        ...
        "TASK:\n"
        "Using the world data, produce ONE in-world response as either an appropriate character "
        "or the Narrator. Keep it concise. You may include bracketed directions like [cautiously] "
